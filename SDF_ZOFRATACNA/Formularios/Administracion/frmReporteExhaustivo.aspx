...
<style>
        body { background-color: #f8f9fb; color: #191c1e; }
        .glass-panel { background: rgba(248, 249, 251, 0.85); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); }
        .environmental-shadow { box-shadow: 0 20px 40px rgba(25, 28, 30, 0.06); }
    </style>
</head>
