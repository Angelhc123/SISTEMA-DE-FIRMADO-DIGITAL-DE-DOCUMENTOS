...
<!-- TopNavBar -->
<nav class="fixed top-0 right-0 left-72 h-16 z-40 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl shadow-sm dark:shadow-none font-public-sans text-sm tracking-wide bg-slate-50 dark:bg-slate-900 transition-all duration-300 ease-in-out">
<div class="flex items-center justify-between px-10 h-full w-full">
<div class="hidden">
<span class="text-lg font-black tracking-tighter text-[#001E40] dark:text-white uppercase">SDF ZOFRATACNA</span>
</div>
<!-- Desktop Nav Links -->
<div class="hidden md:flex gap-6 h-full items-end pb-1">
<a class="text-[#001E40] font-bold border-b-2 border-[#001E40] pb-1" href="#">Dashboard</a>
</div>
<!-- Trailing Actions -->
<div class="flex items-center gap-6">
<button class="text-slate-400 hover:text-[#001E40] transition-colors hover:text-[#001E40] dark:hover:text-white flex items-center gap-2">
<span class="material-symbols-outlined">logout</span>
                    Cerrar Sesión
                </button>
<div class="h-8 w-8 rounded-full bg-surface-container-high overflow-hidden">
<img alt="Avatar de Usuario" class="h-full w-full object-cover" data-alt="Professional headshot of a man with short brown hair smiling warmly, wearing a light blue collared shirt" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCE3I9O8Ci-GHJzkfOJzn_LJge1PY0avGfrs3yDZGMtqG9MhM-P4_l08H6nGeeAlgYumPHr3CqOSHxVXsKrD9gkQ36lyd2i6ydA7QWrSqmm6mnDtGmxEMp-duD8OGUwN1Jhvro_XUAF1Ns8Lec95FeU-RkuOBFIGh3KcYRKk4sLaXxRB2Mh92Mk1DOjaOFnyJ-yfkakHSsNVylwu9-IyjQ8lLKJAfLTdjYy_1AXpbNOlrSn2yZsenD_A-zSMfh3NLlO5-qsBzxQ8ocu"/>
</div>
</div>
</div>
</nav>
<!-- SideNavBar -->
<aside class="h-screen w-72 fixed left-0 top-0 border-r-0 bg-white dark:bg-slate-950 shadow-[8px_0_24px_rgba(0,30,64,0.04)] bg-slate-50 dark:bg-slate-900/50 z-50 font-public-sans tracking-tight text-sm font-medium">
<div class="flex flex-col h-full py-8">
<!-- Header -->
<div class="px-6 mb-10 flex flex-col items-start gap-2">
...
<a class="flex items-center gap-3 px-6 py-4 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-200" href="#">
<span class="material-symbols-outlined" data-icon="dashboard">dashboard</span>
                    Dashboard
                </a>
<a class="flex items-center gap-3 px-6 py-4 text-[#001E40] dark:text-white bg-slate-100 dark:bg-[#001E40]/20 font-bold border-r-4 border-[#001E40]" href="#">
...
<button class="bg-gradient-to-br from-primary to-primary-container text-on-primary font-label text-sm font-semibold rounded-md px-6 py-3 h-[46px] hover:opacity-90 transition-opacity">
                Filtrar
            </button>
</section>
