    ...
    <form id="form1" runat="server" class="flex w-full min-h-screen">
        ...
        <aside class="bg-white dark:bg-slate-950 h-screen w-72 fixed left-0 top-0 border-r-0 shadow-[8px_0_24px_rgba(0,30,64,0.04)] z-50 flex flex-col py-8">
            ...
            <nav class="flex-1 px-4 space-y-1 font-public-sans tracking-tight text-sm font-medium">
                ...
                <a runat="server" class="flex items-center gap-3 px-6 py-4 text-[#001E40] dark:text-white bg-slate-100 dark:bg-[#001E40]/20 font-bold border-r-4 border-[#001E40] rounded-l-xl Active: translate-x-1 duration-150 relative group overflow-hidden" href="~/Formularios/Documentos/frmDashboardRegistrador.aspx">
            ...
            <div class="px-8 mt-auto flex items-center gap-3">
                ...
                <div class="flex flex-col">
                    <span class="text-sm font-bold text-primary-container tracking-tight"><asp:Literal ID="litUsuario" runat="server">R. Martinez</asp:Literal></span>
        ...
        <div class="flex-1 ml-72 flex flex-col min-h-screen">
            ...
            <!-- Main Content Canvas -->
            <main class="pt-24 px-12 pb-16 flex-1">
                <!-- Header -->
