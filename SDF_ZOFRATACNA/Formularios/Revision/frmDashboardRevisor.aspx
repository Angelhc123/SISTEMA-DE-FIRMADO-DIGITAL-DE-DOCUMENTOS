        ...
        <nav class="h-screen w-72 fixed left-0 top-0 border-r-0 bg-white shadow-[8px_0_24px_rgba(0,30,64,0.04)] z-50">
            <div class="flex flex-col h-full py-8">
                ...
                <ul class="flex-1 space-y-2">
                    <li>
                        <a runat="server" class="flex items-center gap-3 px-6 py-4 text-[#001E40] bg-slate-100 font-bold border-r-4 border-[#001E40] hover:bg-slate-100 transition-all duration-200" href="~/Formularios/Revision/frmDashboardRevisor.aspx">
                    ...
                    <li>
                        <a runat="server" class="flex items-center gap-3 px-6 py-4 text-slate-500 hover:bg-slate-50 transition-colors hover:bg-slate-100 transition-all duration-200" href="~/Formularios/Revision/frmArchivoRevisor.aspx">
                ...
                <div class="mt-auto px-6 pt-8 border-t border-slate-100">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col">
                            <asp:Label ID="lblNombreUsuario" runat="server" CssClass="font-public-sans tracking-tight text-sm font-bold text-[#001E40]" Text="Revisor"></asp:Label>
                    ...
                    <div class="flex items-center gap-6">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-surface-container-high overflow-hidden border border-outline-variant/20">
                                <asp:Image ID="imgAvatar" runat="server" CssClass="w-full h-full object-cover" ImageUrl="https://lh3.googleusercontent.com/aida-public/AB6AXuAxf9SdqTbPjer2dg9PAupFQONTIQTkgyjwXhbDcnh7zHVP1hXl_iV_DCndzd_WU3RuW9x0ttQzSOCrk7fn1Qv50tKNNyUlRvNTCcWdtuSkp56R2tfwBhIEm6qDfiu_nfGGSwrBORym57Mnl3LsNkwt-xsXe9WifyIJcBOeSrou0z6dzAB9l_TskKlZ1TPBlLVxr-FG2tGng0DIyAFFdttJ_vQKfCzikEFL46SHO33iDbcMavvZSKm1YDbC6SBu1KPrMQ_nfLEs62k2" />
                            </div>
                            <span class="font-public-sans text-sm tracking-wide text-on-surface font-medium">Revisor</span>
                        </div>
                        <asp:LinkButton ID="btnLogout" runat="server" CssClass="text-slate-400 hover:text-[#001E40] transition-colors font-public-sans text-sm tracking-wide flex items-center gap-2" OnClick="btnLogout_Click">
            ...
            <main class="flex-1 pt-24 px-10 pb-12 overflow-y-auto">
                <div class="mb-10 flex justify-between items-end">
                    ...
                    <div class="flex gap-4">
                        <button type="button" class="h-10 px-6 rounded bg-surface-container-highest text-on-surface font-label text-sm font-semibold tracking-wide hover:bg-surface-variant transition-colors flex items-center gap-2">
                            <span class="material-symbols-outlined text-lg">filter_list</span>
                            Filtros
                        </button>
                        <asp:LinkButton ID="btnActualizar" runat="server" CssClass="h-10 px-6 rounded text-on-primary font-label text-sm font-semibold tracking-wide flex items-center gap-2 shadow-sm" Style="background: linear-gradient(135deg, #000511 0%, #001E40 100%);" OnClick="btnActualizar_Click">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    <div class="bg-surface-container-lowest rounded-lg p-6 relative overflow-hidden border border-outline-variant/20 shadow-[0_4px_12px_rgba(0,30,64,0.02)]">
                        ...
                        <div class="flex items-baseline gap-3">
                            <asp:Label ID="lblPendientes" runat="server" CssClass="text-4xl font-headline font-bold text-on-surface" Text="42"></asp:Label>
                        ...
                        <div class="mt-4 pt-4 border-t border-outline-variant/10">
                            <a runat="server" class="text-primary-container font-label text-sm font-semibold hover:underline flex items-center gap-1" href="~/Formularios/Revision/frmMisDocumentosRevisor.aspx">
                    ...
                    <div class="bg-surface-container-lowest rounded-lg p-6 relative overflow-hidden border border-outline-variant/20 shadow-[0_4px_12px_rgba(0,30,64,0.02)]">
                        ...
                        <div class="flex items-baseline gap-3">
                            <asp:Label ID="lblObservados" runat="server" CssClass="text-4xl font-headline font-bold text-on-surface" Text="15"></asp:Label>
                    ...
                    <div class="bg-surface-container-lowest rounded-lg p-6 relative overflow-hidden border border-outline-variant/20 shadow-[0_4px_12px_rgba(0,30,64,0.02)]">
                        ...
                        <div class="flex items-baseline gap-3">
                            <asp:Label ID="lblRevisadosHoy" runat="server" CssClass="text-4xl font-headline font-bold text-on-surface" Text="28"></asp:Label>
                        ...
                        <div class="mt-4 pt-4 border-t border-outline-variant/10">
                            <a runat="server" class="text-primary-container font-label text-sm font-semibold hover:underline flex items-center gap-1" href="~/Formularios/Revision/frmArchivoRevisor.aspx">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 bg-surface-container-lowest rounded-lg p-8 border border-outline-variant/20 shadow-[0_4px_12px_rgba(0,30,64,0.02)] flex flex-col">
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="flex bg-surface-container-low rounded p-1">
                                <button type="button" class="px-3 py-1 bg-surface-container-lowest text-on-surface font-label text-xs font-semibold rounded shadow-sm">Semana</button>
                                <button type="button" class="px-3 py-1 text-on-surface-variant font-label text-xs font-medium hover:bg-surface-container-highest rounded">Mes</button>
                            </div>
                        </div>
                    ...
                    <div class="bg-surface-container-low rounded-lg p-8 border border-outline-variant/10 flex flex-col">
                        ...
                        <asp:LinkButton ID="btnVerTodosUrgentes" runat="server" CssClass="w-full mt-6 py-3 border border-outline-variant/30 rounded font-label text-xs font-semibold text-on-surface hover:bg-surface-container-highest transition-colors text-center" OnClick="btnVerTodosUrgentes_Click">
