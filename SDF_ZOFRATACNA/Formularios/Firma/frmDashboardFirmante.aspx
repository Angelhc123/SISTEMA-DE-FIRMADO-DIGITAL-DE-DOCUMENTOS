...
<title>SDF ZOFRATACNA - Dashboard</title>
...
<!-- SideNavBar -->
<nav class="bg-slate-100 dark:bg-slate-900 text-[#003366] dark:text-blue-400 font-public-sans font-semibold tracking-tight fixed left-0 top-0 h-screen w-72 border-r border-transparent flex flex-col h-full p-4 z-40 hidden md:flex">
<div class="mb-8 px-4 py-2">
<h1 class="text-xl font-bold text-[#001e40] dark:text-white">SDF ZOFRATACNA</h1>
<p class="text-sm font-normal opacity-70">Arquitectura de Confianza</p>
</div>
<ul class="flex-1 space-y-2">
<li>
<a class="text-[#001e40] dark:text-white font-bold bg-white dark:bg-slate-800 rounded-lg shadow-sm scale-95 active:scale-90 transition-transform flex items-center gap-3 px-4 py-3" href="#">
<span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">dashboard</span>
                    Dashboard
                </a>
</li>
<li>
<a class="text-slate-500 dark:text-slate-400 hover:text-[#003366] dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-colors duration-200 scale-95 active:scale-90 transition-transform flex items-center gap-3 px-4 py-3 rounded-lg" href="#">
...
<!-- TopNavBar -->
<header class="bg-white/85 dark:bg-slate-950/85 backdrop-blur-md text-[#001e40] dark:text-white font-inter text-sm fixed top-0 right-0 w-[calc(100%-18rem)] h-16 z-50 border-b border-slate-200/50 dark:border-slate-800/50 shadow-sm dark:shadow-none flex items-center justify-between px-8 hidden md:flex">
<div class="flex-1">
<span class="hidden">SDF ZOFRATACNA</span>
</div>
<div class="flex items-center gap-4 opacity-90 hover:opacity-100">
<button class="text-slate-600 dark:text-slate-400 hover:text-[#003366] dark:hover:text-blue-300 transition-all p-2 rounded-full">
...
<button class="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-[#003366] dark:hover:text-blue-300 transition-all">
<span class="font-semibold text-[#003366]">Cerrar Sesión</span>
<img alt="Usuario Session" class="w-8 h-8 rounded-full ml-2" data-alt="professional portrait of a man in a business setting with soft lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAaxALfWT64Q_EHMgU1gm4qrjhR2bMGY9EEiOoamGujsUW5zjIL6nJGFBSVrxDfe9uA_7p4E1Nc8YNp7YYTgpUIvak8wYhpGk552aHpsLLomd1Sy1V-arhskcYTzqtL-BEdQHuphHjInncxzDPKdOhwqxMQI4O6EZKiRLbF0Ks2g14K5RDROgPFoveA2OsLr2CB83MKdqStLuGxmXB2Vhm2AxIeqQ6pAuhk2lARIms00EWfW268rjtrSReL87OgTG3MjRqWE8R7q96X"/>
</button>
</div>
</header>
<!-- Main Content Canvas -->
...
<p class="font-headline text-4xl font-semibold text-on-error-container">12</p>
</div>
<div class="mt-4">
...
<p class="font-headline text-4xl font-semibold text-on-tertiary-fixed-variant">34</p>
</div>
<div class="mt-4">
...
<p class="font-headline text-4xl font-semibold text-primary">156</p>
</div>
<div class="mt-4">
...
<button class="text-primary font-label text-sm hover:underline flex items-center gap-1">
...
<div>
<button class="bg-primary text-on-primary font-label text-sm px-4 py-2 rounded shadow-sm hover:bg-primary-container transition-all duration-200 ease-out flex items-center gap-2">
...
<div>
<button class="bg-secondary-container text-on-secondary-container font-label text-sm px-4 py-2 rounded hover:bg-surface-variant transition-all duration-200 ease-out flex items-center gap-2">
